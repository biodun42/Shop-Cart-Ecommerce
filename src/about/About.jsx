...
const aboutList = [
  {
    imgUrl: "../../public/images/about/icon/01.jpg",
    imgAlt: "about icon rajibraj91 rajibraj",
    title: "Skilled Instructors",
    desc: "Distinctively provide acces mutfuncto users whereas communicate leveraged services",
  },
  {
    imgUrl: "../../public/images/about/icon/02.jpg",
    imgAlt: "about icon rajibraj91 rajibraj",
    title: "Get Certificate",
    desc: "Distinctively provide acces mutfuncto users whereas communicate leveraged services",
  },
  {
    imgUrl: "../../public/images/about/icon/03.jpg",
    imgAlt: "about icon rajibraj91 rajibraj",
            ...
            <div className="col">
              <div className="about-left">
                <div className="about-thumb">
                  <img src="../../public/images/about/01.jpg" alt="about" />
                  <div className="abs-thumb">
                    <img src="../../public/images/about/02.jpg" alt="about" />
                  </div>
